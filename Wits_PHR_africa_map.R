...
partners_data <- tribble(
  ...
  "Medical Research Council", "Pretoria", "South Africa", -25.7449, 28.1879, "HE²AT", c("HE²AT"),
...
partners_sf <- partners_sf %>%
  mutate(short_name = case_when(
    ...
    str_detect(institution, "Medical Research Council") ~ "MRC",
