...
partners_data <- tribble(
  ...
  "Sydney Brenner Institute for Molecular Bioscience", "Johannesburg", "South Africa", 0, 0, 0, 0, 0, 0, 1, 0,
  "Rahima Moosa Mother & Child Hospital", "Johannesburg", "South Africa", 0, 0, 0, 0, 0, 0, 1, 0,
  "Centre for Infectious Disease Epidemiology and Research, University of Cape Town", "Cape Town", "South Africa", 0, 0, 0, 0, 1, 0, 0, 0
)
