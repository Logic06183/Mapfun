...
heat_countries <- c(
  ...
  "Mauritania", "Ethiopia", "Kenya", "Uganda", "Tanzania", 
...
ggplot() +
  ...
  scale_fill_manual(
    values = c("TRUE" = alpha("#FFE0B2", 0.7),  # Light yellow for HE²AT countries
               "FALSE" = "white"),               # White for non-HE²AT countries
    name = NULL,
    labels = c("HE²AT Contributing Countries", ""),
    breaks = c("TRUE", "FALSE"),
    guide = guide_legend(
